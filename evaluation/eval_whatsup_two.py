...
parser.add_argument(
    "--qa_json_path",
    default="./playground/benchmarks/AdaptVis/data/coco_qa_two_obj.json",
    help="Path to the QA JSON file."
)
parser.add_argument(
    "--adaptvis_json_path",
    default="./playground/benchmarks/AdaptVis/prompts/COCO_QA_two_obj_with_answer_four_options.jsonl",
    help="Path to the QA JSON file."
)
parser.add_argument(
    "--image_folder",
...
parser.add_argument(
    "--output_dir",
    default="./results/whatsup_results_two",
...
for idx, (image_id, question1, question2) in enumerate(tqdm(qa_data)):
    ...
    prompt = match.group(1) + 'Answer with a single word from left, right, above, or below.\n'
